...
void WebForumData::addOpPost(const std::string& user, const std::string& title, const std::string& content, const std::string& date, const std::string& time)
{
	if (!full())
	{
...
void WebForumData::addReplyPost(const int& OpId, std::vector<int> ReplyId, const std::string& user, const std::string& content, const std::string& date, const std::string& time)
{
	if (!full())
	{
...
void WebForumData::deleteOpPost(const int& OpId)
{
...
void WebForumData::deleteReplyPost(const int& OpId, std::vector<int> ReplyId)
{
	if ((forumOpList[OpId] != nullptr) && ((!forumOpList[OpId]->replies.empty()) && (!ReplyId.empty())))
	{
...
void WebForumData::modifyReplyPost(const int& OpId, std::vector<int> ReplyId, const std::string& content)
{
	if ((forumOpList[OpId] != nullptr) || (!forumOpList[OpId]->replies.empty()))
		findReply(OpId, ReplyId).first->postContent = content;
} // end modifyReplyPost

void WebForumData::modifyOpPost(const int& OpId, const std::string& content)
{
	if (forumOpList[OpId] != nullptr)
		forumOpList[OpId]->postContent = content;
} // end modifyOpPost

std::string WebForumData::searchPostTitle(const std::string& input)
{
...
std::string WebForumData::searchUserDirectReplies(const int& OpId, const std::string& input, const char& sortBy = 'o')
{
	std::string fullPost = "";
...
std::vector<int> WebForumData::returnMatchOpIds(const std::string& input)
{
	// OpId, match count
...
std::vector<int> WebForumData::returnMatchDirectReplyIds(const int& OpId, const std::string& input)
{
...
std::string WebForumData::returnPostData(const int& OpId, const char& sortBy = 'o')
{
	std::string fullPost;
	std::string opPostId = std::to_string(OpId);
	std::string opUser = forumOpList[OpId]->postUser;
...
std::string WebForumData::returnOpPostList(const std::vector<int>& opIdVec)
{
	std::string fullList = "{";
...
std::string WebForumData::returnFullOpList(const char& sortBy = 'o')
{
	std::string fullList = "{";
	std::string opPostId, opUser, opTitle, opDate, opTime;
...
std::string WebForumData::recurReplies(const int& replyId, std::shared_ptr<ForumPostNode> replyPtr)
{
...
void WebForumData::reserveListSpace()
{
...
replyLocationPair  WebForumData::findReply(const int& OpId, std::vector<int> ReplyId)
{
...
int WebForumData::matchCount(const int& OpId, const std::string& input)
{
	int matchCount = 0;
...
std::vector<std::string> WebForumData::splitString(std::string input)
{
...
void WebForumData::upperCase(std::string& input)
{
	unsigned int i;
	for (i = 0; i < input.length(); i++)
	{
...
bool WebForumData::validChar(const char& input)
{
...
std::string WebForumData::cleanString(const std::string& input)
{
	std::string result = "";
...
bool WebForumData::isNumChar(const char& input)
{
	return (input >= '0') && (input <= '9');
}

// Function for sorting found matches from searches in descending order of total matching words
bool WebForumData::sortBySecond(const std::pair<int, int>& firstPair, const std::pair<int, int>& secondPair)
{
